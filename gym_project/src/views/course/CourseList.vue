...
//列表
const { listParm,tableDate,getList,sizeChange,currentChange,tableHeight,searchBtn,resetBtn,reFresh } = useTable();
//新增、编辑
const { addBtn, editBtn, deleteBtn,addRef } = useCourse();
</script>
